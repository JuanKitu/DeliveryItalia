...
CREATE TABLE domicilioPertCalle(  --que domicilio pertenece a que calle
...
CREATE TABLE clienteEnDOmicilios(      --que cliente se encuentra en que domicilio
...
CREATE TABLE gustosEnPotes(  --gusto de potes muchos a muchos(rel)
idPote int NOT NULL,
